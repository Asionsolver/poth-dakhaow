        ...
        <div className="p-7 h-screen  flex justify-between flex-col">
            <div>
                ...
                <form onSubmit={submitHandler}>
                    <h3 className="text-base font-medium mb-2">What&lsquo;s are Captain name</h3>
                    ...
                    <h3 className="text-base font-medium mb-2">What&lsquo;s are email</h3>
                    ...
                    <div className='my-2'><p className='text-center'>Already have a account? <Link to="/captain-login" className='text-ripeMango'>Captain Login here</Link></p></div>
                </form>
            </div>
            <div className='mt-5'>


                <p className='text-xs leading-tight'>This sit is protected by reCAPTCHA and the <span className='text-blue-400 underline'>Google Privacy Policy</span> and <span className='text-ripeMango underline'>Terms of Service</span> apply.</p>
